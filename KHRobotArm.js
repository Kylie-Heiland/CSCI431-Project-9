...
var MIDDLE_ARM_WIDTH  = 0.5; //Added
var MIDDLE_ARM_HEIGHT = 3.0; //Added
...
var Base = 0;
var LowerArm = 1;
var MiddleArm = 2; //Added this!!
var UpperArm = 3; //Changed from 2 to 3
...
var render = function() {
    ...
    modelViewMatrix = mult(modelViewMatrix, translate(-2.25, BASE_HEIGHT, 0.0));
	...
	modelViewMatrix = mult(modelViewMatrix, translate(0.0, LOWER_ARM_HEIGHT, 0.0)); //added
    modelViewMatrix = mult(modelViewMatrix, rotate(theta[MiddleArm], vec3(0, 0, 1 ))); //added
    middleArm(); //added
